...
RECIPIENT_EMAILS = os.getenv("RECIPIENT_EMAILS", "maunguyen0179@gmail.com").split(",") if os.getenv("RECIPIENT_EMAILS") else ["maunguyen0179@gmail.com"]  # Comma-separated emails
